...
export default function ApplicantCard({ name, email, appliedAt, status }) {
    const statusStyles = {
                ...
                <div className="flex flex-col items-end">
                   <div className="mb-6 ml-auto">
                    ...
                    <div className="flex shrink-0 gap-2">
                        <button className="rounded-lg bg-green-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-green-700 active:scale-[0.97] transition duration-75 cursor-pointer">
                            Accept
                        </button>
                        <button className="rounded-lg bg-red-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-red-700 active:scale-[0.97] transition duration-75 cursor-pointer">
                            Reject
                        </button>
                    </div>
                </div>
