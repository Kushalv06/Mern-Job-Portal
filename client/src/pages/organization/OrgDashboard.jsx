            ...
            <main className="min-h-screen bg-slate-50 px-4 py-6">
                <div className="mx-auto max-w-5xl space-y-6">
                    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <p className="mt-2 text-slate-600">Manage your job posts and hiring activity.</p>
                        <button className="mt-6 rounded-lg bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700 active:scale-[0.97] cursor-pointer">Post a Job</button>
                        <button className="bg-blue-600 px-4 py-2 rounded-lg text-white font-medium ml-3 hover:bg-blue-700 active:scale-[0.97] cursor-pointer">Manage Jobs</button>
                    </section>
